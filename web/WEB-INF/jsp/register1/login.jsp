...
<body>
    ...
    Login1<hr/>
    <s:form method="POST" namespace="/user1" action="login">
    ...
    <a href="/control_panel/user1/goRegister">Register</a><br/>
    <a href="/control_panel/user1/goreset">Forgot Password</a><br/>
    <a href="/control_panel/user1/status">Status</a><br/>
</body>
</html>
