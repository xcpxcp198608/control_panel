...
<div id="head">
    <div id="head_content">
        ...
        <a class="navigation" href="/control_panel/pushmessage/show">PushMessage</a>
...
<div id="content">
    <br/><br/>
    <div id="content1">
        <s:form action="update" namespace="/message" method="post">
            <s:hidden name="id"></s:hidden>
            <s:textfield name="messageInfo.title" label="Title" size="100" ></s:textfield>
            <s:textfield name="messageInfo.content" label="Content" size="100" ></s:textfield>
            <s:textfield name="messageInfo.type" label="Type" size="100" ></s:textfield>
            <s:textfield name="messageInfo.link" label="Link" size="100" ></s:textfield>
