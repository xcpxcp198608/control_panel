...
<div id="content">
    ...
    <div id="content1">
        ...
        <s:form action="upload" namespace="/kodiimage" method="post" enctype="multipart/form-data">
        ...
        <s:form action="update" namespace="/kodiimage" method="post">
            <s:hidden name="id"></s:hidden>
